...
function getAllRes() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, elevenlabs.models.getAll()];
                case 1:
                    models = _a.sent();
                    console.log("ALL MODELS", models);
                    return [4 /*yield*/, elevenlabs.voices.getAll()];
                case 2:
                    voices = _a.sent();
...
function generateAudio() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, elevenlabs.generate({
                        voice: "Dave",
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, elevenlabs_1.play)(audio)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
